...
def exp(start_day=0, end_day=4):
    # 所有的model
    model_name_list = ["NHITS", "NBEATS", "Movingavg", "Movingmax", "Maxvalue", "Avgvalue"]
    # model_name_list = ["Dsp",]
    # 所有的pattern
    pattern_list = ["continuous",]
    # 存储结果
    result_dict_list = []
        ...
        for trace in trace_dict[pattern]:
            ...
            for model_name in model_name_list:
                ...
                try:
                    ...
                    # 生成文件名
                    file_name = f"{model_name}_{dataset_name}_{trace_name}_{pattern}_seq_len_{seq_len}_pred_len_{pred_len}_mae_{mae}_train_t_{train_t}_pred_t_{pred_t}_CH.pdf"
