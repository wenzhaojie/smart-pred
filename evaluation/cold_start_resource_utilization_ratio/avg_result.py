...
def merge_crane_dataset():
    ...
    filter_methods = ['SmartPred', "Crane", "Keepalive", "Icebreaker"]
    filter_metrics = ['cold_start_invocation_ratio', 'utilization_ratio', ]
...
def merge_azure_dataset():
    csv_files = [
        ...
        "results/AzureFunction2019_4be8e60df29812b4e9cc904e88eb9999893bfe2c56055aed62d400d4c03fdea9_0_4/experiment_parameters.csv",
        "results/AzureFunction2019_24b667b07c179d44229776d6e4b9cb061632584a8f27b93e9ed051959e1e1a37_0_4/experiment_parameters.csv",
    ]
    filter_methods = ['SmartPred', "Crane", "Keepalive", "Icebreaker"]
    filter_metrics = ['cold_start_invocation_ratio', 'utilization_ratio', ]
