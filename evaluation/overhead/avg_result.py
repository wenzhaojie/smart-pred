...
def merge_crane_dataset():
    ...
    filter_methods = ['SmartPred', 'NHITS', 'NBEATS', "DLinear", "Crane", "Icebreaker"]
    filter_metrics = ["train_t", "predict_t"]
...
def merge_huawei_dataset():
    ...
    filter_methods = ['SmartPred', 'NHITS', 'NBEATS', 'PatchTST', "DLinear", "Crane", "Icebreaker"]
    filter_metrics = ["train_t", "predict_t"]
