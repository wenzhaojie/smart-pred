...
def start_exp():
    my_exp = ExpOneTrace(
        dataset_name="AzureFunction2019",
        function_name="1ad3a3335bb2c127474fbfd71ef278319ad4c58ed0bfe4d5e152f77d18ebbe33",
        start_day=0,
        end_day=4,
    )
    ...
    my_exp.init_baselines(
        ...
        baselines_name_list=["Maxvalue", "Minvalue", "Avgvalue","Movingavg", "Movingmax", "Movingmin", "Quantile", "SmartPred", "NHITS", "NBEATS", "PatchTST", "DLinear"],
