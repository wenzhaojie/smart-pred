...
class TestFusionSegmentModel:
    def __init__(self):
        ...
        self.model = Fusion_segment_model(fusion_model_params_dict=self.fusion_model_params_dict)
...
if __name__ == "__main__":
    test_fusion_model = TestFusionSegmentModel()
